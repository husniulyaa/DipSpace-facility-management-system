...
const confirmationIcon = toggleConfirmation.querySelector(".material-symbols-outlined");
...
toggleConfirmation.addEventListener("click", function () {
    togglePasswordVisibility(confirmationInput, confirmationIcon, toggleConfirmation);
});
